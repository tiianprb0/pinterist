    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderUserList(users) {
                ...
                const userLevels = ['Pengguna Biasa', 'tempted', 'Naughty', 'sinful']; // Include 'Pengguna Biasa'
                ...
                users.forEach(user => {
                    ...
                    if (!user.isAdmin) { // Only show level control for non-admin users
                        levelSelectHtml = `
                            <div class="user-level-control">
                                ...
                                <select id="userLevel_${user.username}" data-username="${user.username}" data-initial-level="${user.level || 'Pengguna Biasa'}">
                                ...
                                <!-- Removed save-level-btn as requested -->
                            </div>
                        `;
                    } else {
                    ...
                    // const saveLevelBtn = userItem.querySelector(`#saveLevelBtn_${user.username}`); // Removed as requested

                    if (userLevelSelect) { // No need to check saveLevelBtn anymore
                        userLevelSelect.addEventListener('change', function() {
                            // Directly update level on change, no save button needed
