        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function makeApiRequest(endpoint, method = 'GET', data = null) {
                try {
                    ...
                    // Hanya tambahkan headers dan body jika ada data yang dikirimkan dan bukan GET
                    if (data !== null && typeof data !== 'undefined' && method !== 'GET') {
                        options.headers = { 'Content-Type': 'application/json' };
                        options.body = JSON.stringify(data);
                    } else if (method === 'POST' && (data === null || typeof data === 'undefined')) {
                        // Untuk POST request tanpa data (misal logout, mark_as_read), pastikan tidak ada body
                        // Browser akan otomatis handle ini atau tidak mengirim header tsb.
                        // Tidak perlu menghapus options.headers; biarkan saja kosong jika tidak ada body.
                    }
                    ...
                    // Jika respons kosong, anggap sukses jika status OK
                    if (!textResponse) {
            ...
            // Fungsi showMessage tetap menggunakan div lokal untuk halaman admin
            ...
            async function handleAdminLogout() {
                try {
                    // Kirim POST request TANPA body data
