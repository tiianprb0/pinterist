...
<body>
    ...
    <div id="editProfileOverlay" class="edit-profile-overlay">
        <div id="editProfileSection" class="edit-profile-section">
            ...
            <div class="form-group">
                ...
                <input type="url" id="editProfileImageUrl" value="<?php echo htmlspecialchars($profileImageUrl); ?>" placeholder="Masukkan URL gambar profil">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editProfileImageUrlInput.addEventListener('input', function() {
