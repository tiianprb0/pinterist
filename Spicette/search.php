...
<head>
    ...
    <link rel="stylesheet" href="../style.css"> <!-- Adjust path to style.css -->
    ...
    <style>
        ...
        .search-pins-grid {
            column-count: 5; /* Default for desktop */
            column-gap: 15px;
            padding: 0;
        }
        .search-pin-item {
        ...
        /* NEW: Image Count Overlay for Pin Grid on Search page */
        .pin-image-count-overlay {
            background-color: rgba(0, 0, 0, 0.2); /* 20% transparan */
            color: white;
            border-radius: 8px;
            padding: 5px 8px;
            font-size: 0.9em;
...
<body>
    <header>
        ...
        <div class="header-icons">
            <!-- These are dummy icons; actual implementation would involve dynamic content and user state -->
